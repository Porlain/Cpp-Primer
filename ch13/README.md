...
In this chapter, we should pay special attention to the differences between sections 13.1 and 13.6.3. Such as:

```c++
// 13.1
// &: Simply speaking, it is an alias for a variable.
// All operations on the “&” of a variable are actually operations on the (original) variable it represents.
// And the purpose of const is to protect the value of this variable from being changed.
HasPtr &operator=(const HasPtr &rhs);
// 13.6.3
// Here, the type of the uncertain value is not determined, so the rhs is passed by value.
// When a left-value is passed, a copy constructor will be used for copying, 
// and when a right-value is passed, a move constructor will be used.
...
Yes, during copy initialization, the copy constructor will be called to generate a new sequence number. However, when the f function is called, a new sequence number will be generated. Therefore, the new output result will output different mysns, but not mysns for a, b, and c.

## Exercise 13.16:

> What if the parameter in f were const numbered&? Does that change the output? If so, why? What output gets generated?

Yes, during copy initialization, the copy constructor will be called to generate a new sequence number. Therefore, the new output result will output different mysns, which are mysns for a, b, and c.
...
## Exercise 13.30 [head](ex13_30.h) | [cpp](ex13_30.cpp)

## Exercise 13.31 [head](ex13_31.h) | [cpp](ex13_31.cpp)
...
## Exercise 13.34 [hpp](ex13_34.h) | [cpp](ex13_34.cpp)
...
## Exercise 13.36 [hpp](ex13_34.h) | [cpp](ex13_34.cpp)

## Exercise 13.37 [hpp](ex13_34.h) | [cpp](ex13_34.cpp)
...
[hpp](ex13_44.h) | [cpp](ex13_44.cpp) | [Test](ex13_48.cpp)
...
```cpp
// note: When we use s inside the function body, s is an lvalue, 
// so we need to explicitly use move to turn it into an rvalue
